...
export default function HomePage() {
  ...
  return (
    <div className="h-screen flex overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col bg-[#F1F5F9] overflow-hidden min-w-0">
        <header className="bg-white border-b border-gray-100 px-6 py-3 flex justify-end items-center gap-4 shrink-0">
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-gray-400 overflow-hidden shrink-0 cursor-pointer hover:opacity-90 transition-opacity"
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pb-4 overflow-y-auto">
          ...
          <h1 className="text-4xl font-bold text-text-primary text-center">Good Morning,</h1>
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 max-w-2xl w-full">
            {suggestionCards.map(({ title, subtitle, subtitleColor, icon: Icon }) => (
              <button
                ...
                className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md cursor-pointer transition-all text-left"
              >
